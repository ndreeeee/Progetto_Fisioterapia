...
class MostraListaEsercizi:
    def __init__(self, root, lista_esercizi):
        self.root = root
        ...
        aggiungi_button = ttk.Button(self.main_frame, text="Aggiungi Esercizio", command=lambda: MostraFormAggiungiEsercizio(self.root))
